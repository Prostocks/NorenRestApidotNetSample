...
The Api is a dotNet wrapper of the StarWebAPI which offers a combination of Rest calls and WebSocket for the purposes of Trading.
...
We will be creating an object of StarRestApi to make requests, the callback is an argument of the request method.
...
2. Endpoint: Star Server address
